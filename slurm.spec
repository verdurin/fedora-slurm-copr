...
- disable perlapi.files to fix build failure

* Sat Feb 06 2016 Adam Huffman <bloch@verdurin.com> - 15.08.7-1
- add Fedora CFLAGS to build to fix post-hardening build failure
